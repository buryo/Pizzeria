    ...
    <div class="container m-t-100 m-b-100" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="col-7">
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                    <input class="form-control" type="text" name="name" placeholder="Pizza quattro formaggi">
                </div>
            </div>
            <div class="form-group row ">
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                    <input class="form-control" name="price" type="number" step="any" placeholder="14,95">
                </div>
            </div>
            <div class="form-group row">
